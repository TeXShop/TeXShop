...
Readers who want to use PreTeXt, or at least try it, should read a second document  titled {\bf PreTeXt with TeXShop} in \path{~/Library/TeXShop/Engines/Inactive/PreTeXt}, which  covers setting up PreTeXt and new features in TeXShop which support it.
