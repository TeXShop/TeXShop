...
\title{\TS\ Tips \& Tricks\\\small v0.7.1--2013/08/18}
...
\framebox{\includegraphics[width=2.25in]{figs/SourceToPreviewSync}}}%
\qquad%
\subfloat[][]{%
\label{fig:PreviewToSource}
\framebox{\includegraphics[width=3.25in]{figs/PreviewToSourceSync}}}%
