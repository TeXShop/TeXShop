...
\section{Changes in 5.00}

Using an item in the main TeXShop menu, open ~/Library/TeXShop. You will see a list of folders including an "Engines" folder.  This folder contains the various active TeXShop typesetting engines, and a folder named "Inactive".  Go to Inactive/HTML and drag a copy of the html.engine  to ~/Library/TeXShop/Engines. Go to Inactive/TeX4ht and drag a copy of the TeX4ht.engine  to ~/Library/TeXShop/Engines.
