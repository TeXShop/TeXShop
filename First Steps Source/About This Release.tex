...
\section{Changes in 4.09 - 4.22}

No changes in these versions require user intervention. But it is crucial to read the Changes document for versions 4.08 through 4.22 since there are many Mojave-related changes.
