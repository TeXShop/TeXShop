...
\title{TeXShop Manual \\ Version 1.3.13}
\author{Richard Koch}
...
After this file was placed in the location of the manual, opening the manual in TeXShop provided PageNumber boxes with the correct numbering.
 ...
 \newpage
 \section[Outputting Fix]{Getting TeX and LaTeX to Output the Crucial Line}
...
\section[An Earlier Way]{An Earlier Way to Activate the Fix}
