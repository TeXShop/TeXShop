...
\title{TeXShop Manual \\ Version 1.3.8}
\author{Richard Koch}
...
The version number of the manual  increases when changes are made. Small changes are made with each new TeXShop release, including additional chapters from time to time.
