...
$My_name = 'Latexmk';
$version_num = '4.17';
$version_details = "$My_name, John Collins, 9 June 2010";
...
##
##      9 Jun 2010, John Collins  With $force_mode on, do a better job 
##                                  of completing processing.
##                                Remove long-unused $force_include_mode
##                                  and its -F and -F- options
##      8 Jun 2010, John Collins  Deal with bug about misparsing log file
##                         with non-space-containing filename that is
##                         followed by a space and a message on same line.
