...
\usepackage[scaled=0.85]{berasans} % ss
\usepackage[scaled=0.85]{beramono} %tt\usepackage{scrtime}
...
%M\title{Guide de démarrage rapide\\ pour utiliser\\ le complétement de commande avec \TS}
