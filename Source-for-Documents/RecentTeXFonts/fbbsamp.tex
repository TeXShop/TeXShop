...
\item taboldstyle figures \texttosf{0123456789} (options {\tt oldstyle, tabular});
\item proportional oldstyle figures \textosf{0123456789} (option {\tt oldstyle});
\item superior figures \textsu{0123456789} in all weights and shapes. With the {\tt sups} option, these will be used for footnote markers;
