...
\thispagestyle{empty}
\begin{description}
\item[Package name:] {\tt newtxtext} (Times)
\item[Derived from:] txfonts, TeX Gyre Termes
...
\item taboldstyle (monospaced) figures 0123456789---option {\tt osf} makes these the default text figures, while using lining figures for math; (the TeXGyreTermes package doesn't seem to have an option for this;)
