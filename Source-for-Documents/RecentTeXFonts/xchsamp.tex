...
\usepackage[osf,scaled=.97]{XCharter}
...
\item proportional oldstyle figures with two choices for `one': 0123456789 and \textosfI{0123456789}---options {\tt osf} and {\tt osfI} set the default figure style in text accordingly;
