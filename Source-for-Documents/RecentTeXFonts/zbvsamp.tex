...
\thispagestyle{empty}
\begin{description}
\item[Package name:] {\tt Baskervaldx} (Baskerville)
\item[Derived from:] Baskervald
...
\item lining figures, both tabular $0123456789$ and proportional \textlf{0123456789};
\item oldstyle figures, both tabular 0123456789 and proportional \textosf{0123456789}---options {\tt osf} with one of {\tt tabular}, {\tt proportional} selects the default text figures, while using tabular lining figures for math;
\item superior figures {\sufigures0123456789}. The option {\tt sups} forces their use as footnote markers;
...
\begin{verbatim}
\usepackage[full]{textcomp}
\usepackage[osf,sups]{Baskervaldx} % osf for text, not math
\usepackage{cabin} % sans serif
\usepackage[varqu,varl]{inconsolata} % sans serif typewriter
\usepackage[baskervaldx,bigdelims,vvarbb]{newtxmath} % bb from STIX
