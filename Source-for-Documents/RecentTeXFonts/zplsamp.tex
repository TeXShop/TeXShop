...
\thispagestyle{empty}
\begin{description}
\item[Package name:] {\tt newpxtext} (Palatino)
\item[Derived from:] TeX Gyre Pagella
...
\item taboldstyle (monospaced) figures 0123456789---option {\tt osf} makes these the default text figures, while using lining figures for math; (the TeXGyrePagella package doesn't seem to have an option for this;)
